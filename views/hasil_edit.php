<?php
$nope=$_GET['nope'];
$ambil=  mysqli_query($koneksi, "SELECT * FROM tbl_akhir WHERE kode ='$nope'") or die ("SQL Edit error");
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              ...
                              <div class="form-group">
                            <label for="jumlah_keluar" class="col-sm-3 control-label">Jumlah Masuk </label>
                            <div class="col-sm-9">
...
if($_POST){
  ...
  $sjumlah_keluar=$_POST['jumlah_keluar'];
   $stok_akhir=$_POST['stok_ak'];
