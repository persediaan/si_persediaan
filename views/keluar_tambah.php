        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Tambah Data Produk Terbaru</h3>
                </div>
...
if($_POST){
  ...
  $jumlah_keluar=$_POST['jumlah_keluar'];
    ...
    //buat sql
    $sql="INSERT INTO tbl_keluar VALUES ('$kode_input','$tanggal','$kode','$nama_produk','$harga,'$stok_awal','$jumlah_masuk','$jumlah_bs,'$jumlah_masuk')";
    $sqlpersediaan="UPDATE tbl_produk SET status='Dipinjam' WHERE kode='$nope'";
    $query=  mysqli_query($koneksi, $sql) or die ("SQL Simpan Data Produk Terbaru Error");
    $querypersediaan=  mysqli_query($koneksi, $sqlpersediaan) or die ("SQL Simpan Data Error");
    if ($query){
