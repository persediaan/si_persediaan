            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">Tanggal</th><th>Kode</th><th>Nama Produk/th><th>Harga</th><th>Stok Awal</th><th>Jumlah Masuk</th><th>Jumlah BS</th><th>Jumlah Keluar</th><th>Stok Akhir</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="report/hasil_satu.php?kode=<?= $data['kode'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/hasil_semua.php" target="_blank" class="btn btn-info btn-sm">
...
<div id="cetak_perbulan" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/hasil_perbulan.php" method="post">
        <h4>Pilih bulan </h4>
...
<div id="cetak_pertahun" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/hasil_pertahun.php" method="post">
        <h4>Pilih tahun</h4>
        <select name="tahun" class="form-control">
          <?
            for ($i=substr(date("d-m-Y"),6,4); $i > substr(date("d-m-Y"),6,4)-5; $i--) { ?>
